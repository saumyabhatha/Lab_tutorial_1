...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='D:\\AU\\PSY310\\Staircase procedure\\Staircase_lastrun.py',
...
text_2 = visual.TextStim(win=win, name='text_2',
    text='A grating will appear on either the left side or the righ side of the screen. You have to respond with left or right arrow key based on the location of the grating. \n\nTo continue to the experiment press space. ',
    font='Open Sans',
